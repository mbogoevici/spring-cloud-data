...
public class TaskConfiguration {
	...
	public static class H2ServerConfiguration {
		...
		public BatchDatabaseInitializer batchRepositoryInitializerForDefaultDBForServer(DataSource dataSource,
																						Server server, ResourceLoader resourceLoader) {
			return new BatchDatabaseInitializer(dataSource, resourceLoader, new BatchProperties());
		}
	...
	public static class NoH2ServerConfiguration {
		...
		@Bean
		public BatchDatabaseInitializer batchRepositoryInitializerForDefaultDB(DataSource dataSource, ResourceLoader resourceLoader) {
			return new BatchDatabaseInitializer(dataSource, resourceLoader, new BatchProperties());
		}
